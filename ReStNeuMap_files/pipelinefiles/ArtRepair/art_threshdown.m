function art_threshdown
% Function art_threshdown  (v.2.2)
%
% Helper function to art_global.  Grabs the saved global data
% from the main figure and extracts the relevant current
% threshold info from the displayed current threshold, then 
% decreases the threshold by a small increment for both movement
% and global intensity, re-calculates the outlier list, and 
% redraws the text list and graphical outlier display.
% ------------------------------
...
% All volumes to be repaired from global intensity and motion
