function zout = alpha_art_despike(Images,FiltType,Despike)
%====================================================================================
%====================================================================================
...
spm_progress_bar('Init',nscans,'Despiking','scans completed');
